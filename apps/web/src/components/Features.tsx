...
export default function Features() {
  ...
  return (
    <div className="w-[80%] min-h-screen mx-auto flex flex-col mb-20 justify-items-center text-center text-white gap-y-7">
      <div className="flex flex-col gap-y-5">
        ...
        <p className="text-5xl w-[40%] mx-auto font-semibold">
          Powerful Features for Effortless API Integration
        </p>
        <p className="text-gray-400 text-lg w-[60%] mx-auto">
      ...
      <div className="w-[80%] mx-auto flex flex-wrap justify-center gap-4">
        {features.map((feat) => (
          <div key={feat.id} className={`${feat.width} h-96 overflow-hidden bg-[#0c0e13] border-t-1 border-1 border-gray-800/60 border-t-gray-500/60 rounded-2xl`}>
